...
# para tranajar con estas listas existen las funciones o metodos
...
print(trabajadores[1:4]) # el primer valor dice desde donde empezar, el 2ndo, habla de la cantidad de valores a imprimir